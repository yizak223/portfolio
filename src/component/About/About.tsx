        ...
        <section id='About' className='h-100'>
            <div className='h-full flex gap-9 justify-center items-center'>
                <div className='bg-white flex gap-9 justify-around items-center w-75 h-75 rounded-lg'>
                    <img className='rounded-l-lg object-cover size-full shadow-b-lg' src={me} alt="me" />
                    <div className='leading-loose text-black'>
                        <div className='flex flex-col items-center'>
                            ...
                            <p className='mb-7 font-bold'>Full Stack Developer</p>
                        </div>
                        <p className='w-30 p-2 leading-6 font-custom'>
